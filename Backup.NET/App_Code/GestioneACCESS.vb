...
Public Class GestioneACCESS
    ...
    Public Function LeggeImpostazioniDiBase(Chiave As String, Optional TipoDbPassato As Integer = -1) As Boolean
    ...
    Public Function ApreDB(idProc As Integer) As Object
        ...
        Catch ex As Exception
            ScriveErrore(idProc, ex.Message)
        End Try

        Return Conn
    End Function

    Private Sub ScriveErrore(idProc As Integer, Errore As String)
        Dim ope As New RoutineVarie
        ope.ScriveLogServizio(idProc, "ERRORE " & Errore)
        ope = Nothing
    End Sub

    Private Function ControllaAperturaConnessione(idProc As Integer, ByRef Conn As Object) As Boolean
    ...
    Public Function EsegueSql(idProc As Integer, ByVal Conn As Object, ByVal Sql As String) As String
        Dim AperturaManuale As Boolean = ControllaAperturaConnessione(idProc, Conn)
        ...
        Try
            Conn.Execute(Sql)
        Catch ex As Exception
            ScriveErrore(idProc, "ERRORE in EsegueSQL:" & Sql & " -> " & ex.Message)
            Ritorno = False
        End Try
    ...
    Public Function EsegueSqlSenzaTRY(idProc As Integer, ByVal Conn As Object, ByVal Sql As String) As String
        Dim AperturaManuale As Boolean = ControllaAperturaConnessione(idProc, Conn)
        Dim Ritorno As Boolean = True
        Dim Errore As String = ""
    ...
    Public Function LeggeQuery(idProc As Integer, ByVal Conn As Object, ByVal Sql As String) As Object
        Dim AperturaManuale As Boolean = ControllaAperturaConnessione(idProc, Conn)
        ...
        Catch ex As Exception
            ...
            ScriveErrore(idProc, "ERRORE in LeggeQuery:" & Sql & " -> " & ex.Message)
        End Try
